...
public class World2 extends JPanel implements ActionListener, KeyListener/*, MouseListener, MouseWheelListener*/ {
    ...
    // makeing this number higher lags the game
    ...
    public void paintComponent(Graphics g) {
        ...
        double fps = 1000000.0 / frameDrawTime;
        g.drawString(String.format("FPS (UNRELIABLE): %.0f", fps), 10, 50); 
    }
